 ...
 * response, they throw an OAuthException, with properties
...
public class OAuthClient {
   ...
   ) throws IOException, OAuthException
   {
      ...
      if ((status < 200) || (status >= 300)) {
         response.flush();
         throw new OAuthException("HTTP response code " + status);
      }
      return response;
   }
