...
/**
 * A {@link Transaction} to update a photo on orkut.
 *
 * @author Shishir Birmiwal
 */
public class UpdatePhotoTx extends Transaction {

  UpdatePhotoTx(Photo photo) {
    super(RequestIds.MEDIAITEMS_UPDATE, MethodNames.MEDIAITEMS_UPDATE);
    ...
    request.addParameter(Params.MEDIA_ITEM, photo.getJson());
  }
